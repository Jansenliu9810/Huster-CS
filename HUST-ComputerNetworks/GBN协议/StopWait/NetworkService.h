...
struct  NetworkService {
	...
	virtual void setRdtSender(RdtSender *ps) = 0;									//设置具体的发送方对象
	virtual void setRdtReceiver(RdtReceiver *ps) = 0;								//设置具体的发送方对象
	virtual void setInputFile(const char *infile) = 0;								//设置输入文件路径
	virtual void setOutputFile(const char *outfile) = 0;								//设置输出文件路径
